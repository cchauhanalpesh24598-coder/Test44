...
public class NotesRepository {
    ...
    /**
     * Encrypt a string field using the current DEK via CryptoManager.
    ...
    /**
     * Decrypt a string field using the current DEK via CryptoManager.
    ...
    public void reEncryptAllNotes(byte[] oldKey, byte[] newKey) {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                // Decrypt with old key (using CryptoManager for DEK-encrypted data)
     ...
     * Uses CryptoManager (DEK-based encryption) for the 2-layer system.
     */
