...
import com.mknotes.app.crypto.PasswordChangeManager;
    ...
    private void showChangePasswordDialog() {
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                // Perform password change using 2-layer DEK system.
                // DEK stays the same -- only the wrapping KEK changes.
                // Notes are NOT re-encrypted.
                PasswordChangeManager pcm = new PasswordChangeManager(SettingsActivity.this);
                boolean success = pcm.changePassword(oldPwd, newPwd);
                if (success) {
                    ...
                    try {
                        if (PrefsManager.getInstance(SettingsActivity.this).isCloudSyncEnabled()
                            ...
                            // Vault metadata is already uploaded by PasswordChangeManager.
                            // No need to uploadAllNotes() since DEK (and thus note ciphertext) is unchanged.
                        }
                    } catch (Exception e) {
